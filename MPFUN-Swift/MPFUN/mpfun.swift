...
extension mpfun {
    ...
    static func mpadd (_ a : MPRNumber, _ b : MPRNumber, _ c : inout MPRNumber, _ mpnw : Int) {
        ...
        var ia, ib, ish, ixa, ixb, ixd, mpnw, m1, m2, m3, m4, m5, na, nb, nd, nsh : Int
    ...
    static func mpmul (_ a : MPRNumber, _ b : MPRNumber, _ c : inout MPRNumber, _ mpnw : Int) {
        ...
        var i1, i2, j, j3, ia, ib, na, nb, nc, n2 : Int
        let mpnwx = 200
        var a1, a2, c1, c2, dc, d1, d2, t1, t2, t3 : Double
    ...
    static func mpnpwr (_ a : MPRNumber, _ n : Int, _ b : inout MPRNumber, _ mpnw : Int) {
        ...
        var i, j, k, kk, kn, k0, k1, k2, mn, mpnw, mpnw1, n, na, nn, nws : Int
        var t1 : Double
    ...
    static func mpnrtr (_ a : MPRNumber, _ n : Int, _ b : inout MPRNumber, _ mpnw : Int) {
        ...
        var i, ia, iq, k, k0, k1, k2, k3, mpnw, mpnw1, mq, n, na, n1, n2, n3, n5 : Int
        var t1, t2, tn : Double
...
//        write (iu, "(4f18.0)") (a[i], i = 0, na + 5)
    ...
    static func mpsqrt (_ a : MPRNumber, _ b : inout MPRNumber, _ mpnw : Int) {
        ...
        var ia, iq, k, k0, k1, k2, k3, mpnw, mpnw1, mq, n, na, nws, nw1, nw2, n2, n7 : Int
        var t1, t2 : Double
...
//        return
    ...
    static func mpdivx (_ a : MPRNumber, _ b : MPRNumber, _ c : inout MPRNumber, _ mpnw : Int)  {
        ...
        var i, ia, ib, iq, k, k0, k1, k2, k3, mpnw, mpnw1, mq, n, na, nb, nws, nw1, nw2, n2, n7 : Int
        var t1, t2 : Double
        let cl2 = 1.4426950408889633; let mprxx = 1e-14; let nit = 3
        var s0 = MPRNumber(repeating: 0, count: mpnw+6)
        var s1 = s0; var s2 = s0; var s3 = s0
...
//        }
    ...
    static func mpfftrc (is, m, n, nsq, x, y) {
...
//    return
    ...
    static func mpfft1 (is, m, n1, n2, x, y) {
...
//    return
    ...
    static func mpfft2 (is, ns, m, n, x, y) {
...
//    return
    ...
    static func mpfft3 (iss, l, ns, m, n, x, y) {
...
//    return
    ...
    static func mplconv (iq, n, nsq, a, b, c) {
